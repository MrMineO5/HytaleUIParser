...
class UIItemSlotButtonElement(
    ...
    override val properties: ItemSlotButtonProperties,
    ...
    override fun withProperties(properties: ElementProperties) = UIItemSlotButtonElement(node, children, properties as ItemSlotButtonProperties)
}
